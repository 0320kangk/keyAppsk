package project.keyappsk.domain.members.entity;

import jakarta.persistence.*;
import lombok.Getter;
import lombok.Setter;
import project.keyappsk.domain.alarm.entity.AlarmMessage;
import project.keyappsk.domain.members.entity.enumerate.Role;
import project.keyappsk.domain.members.entity.enumerate.SignType;
